    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[('Ознакомительный урок', 'Ознакомительный урок'), ('Урок закрепления', 'Урок закрепления'), ('Урок практики', 'Урок практики')], max_length=69, verbose_name='Уроки')),
